...
from files import fatoreshd,mscalc,simulaespectro
...
class FrameAbreArquivos(ttk.Frame):
    ...
    def trataEspectros(self):
        ...
        # Calculando fatores H/D e escrevendo no log
        ...
        for i in range(len(self.fatoreshd)):
            self.controller.frames[frlog.FrameLog].WriteLog('info', ' '*7 + 'Fator H/D [%i]:' %i + '%.3f' %self.fatoreshd[i] + '\n')
