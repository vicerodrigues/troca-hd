...
'
	apt update && apt upgrade -y && apt install python3 python3-dev python3-pil python3-tk tk tk-dev python3-pip libpng-dev libfreetype6-dev libblas-dev liblapack-dev && pip3 install numpy scipy openpyxl matplotlib
